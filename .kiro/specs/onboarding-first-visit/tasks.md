...
- [ ] 2. Criar componente OnboardingView
...
- [ ] 3. Modificar WhatsAppConnectionContext
...
- [ ] 4. Modificar CustomersPage para renderização condicional
  ...
  - _Requirements: 2.5, 3.1, 3.2, 3.3, 4.1, 4.2, 4.3, 4.4_

- [ ] 5. Integrar FirstVisitGuard no App.tsx
  ...
  - Testar que redirecionamento ocorre apenas na primeira visita
  - _Requirements: 1.1, 1.2, 1.3_

- [ ] 6. Adicionar tratamento de erros
  - Adicionar try-catch no FirstVisitGuard para localStorage bloqueado
  - Adicionar fallback no CustomersPage para erro ao carregar customers
  - Implementar botão "Tentar Novamente" em caso de erro
...
- [ ]* 8. Criar testes de integração E2E
...
- [ ] 9. Implementar importação automática após conexão WhatsApp
...
- [ ] 10. Remover coluna de documentos do Dashboard
  ...
  - Remover imports não utilizados (Upload, Search, Eye, Trash2, etc)
...
- [ ] 11. Validar link de Documentos na sidebar
  - Verificar que link "/documents" existe em DashboardLayout.tsx
  - Testar navegação para /documents
  - Garantir que página Documents.tsx está sendo renderizada corretamente
  - Verificar que rota está configurada em App.tsx
