...
export default function Upload() {
  ...
  return (
    <div className="max-w-4xl">
      <h1 className="text-3xl font-bold text-gray-800 mb-2">Upload de Documentos</h1>
      <p className="text-gray-600 mb-8">Envie arquivos PDF, TXT ou MD para o sistema RAG</p>
